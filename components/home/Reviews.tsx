                ...
                <div className={styles.sourceWatermark}>
                  {review.source === "google" ? (
                    <svg width="18" height="18" viewBox="0 0 24 24">
                      <path d="M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.113-5.111 4.113-3.424 0-6.2-2.776-6.2-6.2 0-3.424 2.776-6.2 6.2-6.2 1.498 0 2.868.537 3.944 1.413L21.1 4.22C18.73 2.03 15.65 1 12.24 1 6.033 1 1 6.033 1 12.24s5.033 11.24 11.24 11.24c5.787 0 10.41-4.137 10.41-10.41 0-.696-.08-1.355-.22-1.785H12.24z" fill="#e1dbd3"/>
                    </svg>
                  ) : (
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="#e1dbd3">
                      <path d="M12 .3a3 3 0 00-3 3v1.16A9.52 9.52 0 005.15 7h-.07a4.34 4.34 0 00-1.6 8.35 4.3 4.3 0 002.83.05c.81.93 1.83 1.62 3 2l-1.32 2a1.5 1.5 0 002.5 1.66l1.63-2.45c.29.04.58.07.88.07s.59-.03.88-.07l1.63 2.45a1.5 1.5 0 002.5-1.66l-1.32-2c1.17-.38 2.19-1.07 3-2a4.3 4.3 0 002.83-.05 4.34 4.34 0 00-1.6-8.35h-.07A9.52 9.52 0 0015 4.46V3.3a3 3 0 00-3-3zm-5.5 11a2.25 2.25 0 112.25-2.25A2.25 2.25 0 016.5 11.3zm11 0a2.25 2.25 0 112.25-2.25 2.25 2.25 0 01-2.25 2.25zM12 14.5a2.5 2.5 0 112.5-2.5 2.5 2.5 0 01-2.5 2.5z"/>
                    </svg>
                  )}
                </div>
